...
import { CognitiveDeviceService } from "./handlers/cognitive/device"
import { CognitiveGoalService } from "./handlers/cognitive/goal"
import { CognitiveAgentService } from "./handlers/cognitive/agent"
...
import { deviceHandlers, executionHandlers, goalHandlers, agentHandlers, llmHandlers } from "./handlers/cognitive"
...
export function createRoutes(
  ...
  return Layer.mergeAll(rootApiRoutes, eventApiRoutes, ptyConnectApiRoutes, instanceRoutes, docRoute, uiRoute).pipe(
    Layer.provide([
      ...
      CognitiveDeviceService.defaultLayer,
      CognitiveGoalService.defaultLayer,
      CognitiveAgentService.defaultLayer,
      CognitiveLLMService.defaultLayer,
    ]),
